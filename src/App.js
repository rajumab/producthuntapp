...
class App extends Component {
  ...
  render() {
    return (
      <div>
        ...
        <ProductList products={this.state.products} onVoterIncrease={selectedProduct=> this.onVoterIncrease(selectedProduct)} />
      </div>
    );
  }

  onSearch(searchText) {
    console.log(`From App: ${searchText}`)
  ...
  onVoterIncrease(selectedProduct) {
